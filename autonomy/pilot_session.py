...
class PilotSession:
    def __init__(self,mode='manual'):
        ...
        self.steer=0.;self.effort=0.;self.stamp=0.;self.connected=False
    ...
    def update(self,data,now):
        ...
        self.seq=seq;self.touch=touch;self.stamp=now;self.connected=True
    ...
    def status(self,now):
        return dict(mode=self.mode,connected=self.connected and now-self.stamp<.35,ready=self.ready and now>=self.until,seq=self.seq)
